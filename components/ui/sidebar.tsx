    ...
    >
      ...
      <div
        className={cn(
          ...
          variant === "floating" || variant === "inset"
            ? "pt-3 pr-0 pb-3 pl-3 group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)+(--spacing(4))+2px)] lg:pt-4 lg:pr-0 lg:pb-4 lg:pl-4 xl:pt-3 xl:pr-0 xl:pb-3 xl:pl-3"
